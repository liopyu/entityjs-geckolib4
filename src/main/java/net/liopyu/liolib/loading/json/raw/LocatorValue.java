package net.liopyu.liolib.loading.json.raw;
	...
	public static JsonDeserializer<LocatorValue> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			if (json.isJsonArray()) {
				...
				return new LocatorValue(context.deserialize(json.getAsJsonObject(), net.liopyu.liolib.loading.json.raw.LocatorClass.class), new double[0]);
			}
			else {
