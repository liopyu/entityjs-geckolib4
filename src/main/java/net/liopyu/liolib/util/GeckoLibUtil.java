...
/**
 * Helper class for various LioLib-specific functions.
 */
public final class GeckoLibUtil {
	...
	/**
	 * Register a custom {@link net.liopyu.liolib.core.animation.Animation.LoopType} with LioLib,
	...
	/**
	 * Register a custom {@link net.liopyu.liolib.core.animation.EasingType} with LioLib,
	...
	/**
	 * Register a custom {@link net.liopyu.liolib.loading.object.BakedModelFactory} with LioLib,
	...
	/**
	 * Register a custom {@link SerializableDataTicket} with LioLib for handling custom data transmission.<br>
