package net.liopyu.liolib.model;
...
public abstract class GeoModel<T extends GeoAnimatable> implements CoreGeoModel<T> {
	 ...
	 * @return An {@link Optional} containing the {@link net.liopyu.liolib.cache.object.GeoBone} if one matches, otherwise an empty Optional
	 */
	public Optional<net.liopyu.liolib.cache.object.GeoBone> getBone(String name) {
