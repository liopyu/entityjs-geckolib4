...
import net.liopyu.liolib.network.packet.AnimDataSyncPacket;
...
public interface SingletonGeoAnimatable extends GeoAnimatable {
    /**
     * Register this as a synched {@code GeoAnimatable} instance with LioLib's networking functions.<br>
