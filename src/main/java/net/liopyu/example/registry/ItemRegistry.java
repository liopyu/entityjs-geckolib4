...
import net.liopyu.example.item.*;
import net.liopyu.liolib.LioLib;

public final class ItemRegistry {
	public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, LioLib.MOD_ID);
	public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, LioLib.MOD_ID);
	...
	public static final RegistryObject<CreativeModeTab> GECKOLIB_TAB = TABS.register("geckolib_examples", () -> CreativeModeTab.builder()
			.title(Component.translatable("itemGroup." + LioLib.MOD_ID + ".geckolib_examples"))
